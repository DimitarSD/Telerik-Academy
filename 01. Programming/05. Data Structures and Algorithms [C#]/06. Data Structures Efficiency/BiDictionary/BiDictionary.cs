namespace BiDictionary
{
    ...
    partial class BiDictionary<K1, K2, V> : IBiDictionary<K1, K2, V>
    {
        ...
        /// <summary>
        /// Creates new instance of BiDictionary class
        /// </summary>
        /// <param name="allowDublicateValues">Gets a boolean value to dublicate values or not</param>
        ...
        /// <summary>
        /// Return array of all values in the BiDictionary
        /// </summary>
        ...
        /// <summary>
        /// Return the current count of the BiDictionary
        /// </summary>
        public int Count
        {
            get
        ...
        /// <summary>
        /// Add new element to the BiDictionary
        /// </summary>
        /// <param name="key1">First key to be added</param>
        /// <param name="key2">Second key to be added</param>
